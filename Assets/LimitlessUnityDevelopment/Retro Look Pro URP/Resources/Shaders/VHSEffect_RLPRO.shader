Shader "Hidden/Shader/VHSEffect_RLPRO"
{
		...
		float4 FragDivide(Varyings1 input) : SV_Target
	{
		...
		col.r = tex2D(_InputTexture, positionSS + (amount * half2(_OffsetColorAngle.y, _OffsetColorAngle.x))).r;
		col.b = tex2D(_InputTexture, positionSS - (amount * half2(_OffsetColorAngle.y, _OffsetColorAngle.x))).b;
