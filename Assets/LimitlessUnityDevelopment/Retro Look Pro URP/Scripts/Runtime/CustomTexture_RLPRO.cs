...
public class CustomTexture_RLPRO : ScriptableRendererFeature
{
	...
	public class CustomTexture_RLPROPass : ScriptableRenderPass
	{
		...
		static readonly int _CustomTextureV = Shader.PropertyToID("_CustomTexture");
		static readonly int fadeV = Shader.PropertyToID("fade");
		static readonly int alphaV = Shader.PropertyToID("alpha");
		...
		void Render(CommandBuffer cmd, ref RenderingData renderingData)
		{
			...
			RetroEffectMaterial.SetFloat(alphaV, retroEffect.alpha.value ? 1 : 0);
